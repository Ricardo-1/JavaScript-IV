...
const fred = new Instructor({
 ...
 const ricardo = new Student({
     ...
     age: 31,
     location: 'Chicago',
     previousBackground: 'Automechanic',
     className: 'WEB21',
     favSubjects: ['JavaScript', 'JS', 'Javascript', 'javaScript']
 })    

 const brellin = new ProjectManagers({
    name: 'Will',
    location: 'TX',
    age: 27,
    favLanguage: 'JavaScript',
    specialty: 'Front-end',
    catchPhrase: `Don't forget the homies`,
    gradClassName: 'Academy Star Class 2019',
    favInstructor: 'Spock',
 })

console.log(ricardo.listsSubjects());